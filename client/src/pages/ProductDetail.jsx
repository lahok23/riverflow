...
const ProductDetail = () => {
  ...
  const [selectedSize, setSelectedSize] = useState('') // 用於存儲選中的尺寸
  const [quantity, setQuantity] = useState(1) // 用於存儲購買的數量
  const [product, setProduct] = useState(null) // 用於存儲從後端獲取的商品資料
